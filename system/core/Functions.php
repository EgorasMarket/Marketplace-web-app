...
{
  return '<img src="/public/static/assets/logos/egoras-dollar.png" style="width:10px;" class="img-fluid" >' . $r;
}

function sniajaFormat($r)
{
  return '<img src="/public/static/assets/logos/egoras-dollar.png" style="width:8px;margin-bottom:4px;margin-right:3px;" class="img-fluid" >' . $r;
}
